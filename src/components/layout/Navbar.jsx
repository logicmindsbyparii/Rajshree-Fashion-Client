    ...
    <Box sx={{ width: 320, bgcolor: '#FFF8F0', height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{
        ...
        <IconButton
          ...
          sx={{ color: '#1A1A1A', '&:hover': { bgcolor: 'rgba(107,29,42,0.06)' } }}
        >
          <CloseIcon />
        </IconButton>
      </Box>
          ...
          <ListItem key={item.label} disablePadding sx={{ opacity: 0, animation: `drawerFadeIn 0.4s ${0.05 * i}s forwards` }}>
            <ListItemButton
              ...
              sx={{
                ...
                mx: 1.5,
                borderRadius: '8px',
                bgcolor: location.pathname === item.path ? 'rgba(107,29,42,0.06)' : 'transparent',
            ...
            >
              <ListItemText
                ...
                primaryTypographyProps={{
                  ...
                  color: location.pathname === item.path ? '#6B1D2A' : '#1A1A1A'
                }}
              />
          ...
          <>
            <ListItem disablePadding>
              <ListItemButton sx={{ py: 1.5, px: 3, mx: 1.5, borderRadius: '8px' }}>
                <Box sx={{ width: 32, height: 32, borderRadius: '50%', bgcolor: '#6B1D2A', display: 'flex', alignItems: 'center', justifyContent: 'center', mr: 1.5 }}>
          ...
          >
            ...
            <Typography
              ...
              sx={{
                ...
                color: (scrolled || !isHomePage) ? '#6B1D2A' : '#FFF8F0',
                textDecoration: 'none',
                letterSpacing: '0.02em',
                transition: 'all 0.4s',
                flexGrow: { xs: 1, md: 0 },
                    ...
                    <Button
                      ...
                      sx={{
                        ...
                        '&::after': {
                          ...
                          height: 2,
                          bgcolor: (scrolled || !isHomePage) ? '#6B1D2A' : '#C9A96E',
                  ...
                  <>
                    <IconButton
                      ...
                      sx={{
                        color: (scrolled || !isHomePage) ? '#1A1A1A' : 'rgba(255,248,240,0.85)',
                        transition: 'color 0.3s',
                        '&:hover': { bgcolor: 'rgba(107,29,42,0.06)' }
                      }}
                    >
                      <PersonOutlineIcon />
                    </IconButton>
                  ...
                  <>
                    <Button
                      ...
                      sx={{
                        ...
                        py: 1.5,
                        px: 2,
                        '&:hover': { bgcolor: 'transparent', color: (scrolled || !isHomePage) ? '#6B1D2A' : '#FFF8F0' }
                      }}
                    >
                      Sign In
                    </Button>
                    <Button
                      ...
                      sx={{
                        ...
                        py: 1.2,
                        px: 2.5,
                        borderColor: (scrolled || !isHomePage) ? '#6B1D2A' : 'rgba(255,248,240,0.5)',
                        color: (scrolled || !isHomePage) ? '#6B1D2A' : '#FFF8F0',
                        '&:hover': {
                          borderColor: (scrolled || !isHomePage) ? '#3D0C11' : '#FFF8F0',
                          bgcolor: 'transparent'
                        }
                      }}
                    >
