...
//   // High-end interactive navigation handler
//   const handleNavigation = (targetId) => {
//     // If the user is on the main landing page, trigger a premium smooth scroll experience
//     if (location.pathname === '/') {
//       const targetSection = document.getElementById(targetId);
//       if (targetSection) {
//         // Targets the global window view or a custom scroll parent layout smoothly
//         targetSection.scrollIntoView({ behavior: 'smooth', block: 'start' });
//       } else {
//         // Safe structural fallback if IDs are missing or unmounted
//         navigate('/shop');
//       }
//     } else {
//       // Direct standard page switch route if accessed from internal layout subviews
//       navigate('/shop');
//     }
//   };
...
//       // Clean elegant overlay fade-out transition sequence
...
//       // Perfect content typography staggered entrance setup
...
//       // Decorative vector line scale-in mechanics
//       const lines = decorativeRef.current?.querySelectorAll('.deco-line');
//       if (lines) {
//         tl.fromTo(lines,
//           { scaleX: 0 },
//           { scaleX: 1, duration: 1.2, stagger: 0.2, ease: 'power3.out', transformOrigin: 'left center' },
//           '-=1.0'
//         );
//       }
...
//       // High-performance structural luxury gold ambiance particles
...
//     return () => ctx.revert(); // Instantly erases memory leaks upon unmounting components
//   }, []);
...
//           bottom: 0,
//           background: `
//             radial-gradient(ellipse at 30% 50%, rgba(107,29,42,0.5) 0%, transparent 60%),
//             radial-gradient(ellipse at 80% 20%, rgba(201,169,110,0.08) 0%, transparent 40%),
//             radial-gradient(ellipse at 50% 80%, rgba(61,12,17,0.6) 0%, transparent 50%)
//           `,
//           zIndex: 1
//         }
//       }}
...
//       {/* Luxury Geometric Tailoring Grid Blueprint */}
//       <Box
//         sx={{
//           position: 'absolute',
//           top: 0,
...
//             }}
//           >
//             Established 1998 · Masters of Fine Tailoring
//           </Typography>

//           {/* Luxury High-End Typography Heading Blocks */}
//           <Typography
//             variant="h1"
//             sx={{
...
//           {/* Symmetric Custom Gold Divider Accent Line */}
//           <Box
//             sx={{
//               width: 70,
//               height: '2px',
...
//           {/* Premium Narrative Description Text block */}
//           <Typography
//             variant="body1"
//             sx={{
...
//             }}
//           >
//             Where heritage meets craftsmanship. Each garment is meticulously handcrafted
//             by master artisans using the world's finest fabrics, delivering unparalleled
//             elegance for the discerning gentleman.
//           </Typography>

//           {/* Interactive Fixed & Calibrated CTA Button Container */}
...
//                 textTransform: 'uppercase',
//                 borderRadius: '0px', // Razor-flat edge alignment for high premium look
//                 boxShadow: 'none',
...
//       {/* Balanced Right Edge Framing Layout Component */}
//       <Box
//         ref={decorativeRef}
//         sx={{
//           position: 'absolute',
...
//         }}
//       >
//         <Box className="deco-line" sx={{ width: '1px', height: 140, bgcolor: 'rgba(201,169,110,0.18)', transformOrigin: 'top center' }} />
//         <Box className="deco-line" sx={{ width: 65, height: '1px', bgcolor: 'rgba(201,169,110,0.18)', transformOrigin: 'left center' }} />
//         <Box className="deco-line" sx={{ width: '1px', height: 90, bgcolor: 'rgba(201,169,110,0.12)', transformOrigin: 'top center' }} />
      ...
      sx={{
        ...
        '&::before': {
          ...
          background: `
            ...
            radial-gradient(circle at 15% 80%, rgba(107,29,42,0.35) 0%, transparent 50%)
          `,
          zIndex: 1
        }
      }}
            ...
            >
              ...
              <Box 
                sx={{
                  ...
                  height: 260,
                  borderRadius: '50%',
                  background: 'radial-gradient(circle, rgba(107,29,42,0.4) 0%, transparent 70%)',
                  zIndex: 1,
                  filter: 'blur(10px)'
                }}
              />
